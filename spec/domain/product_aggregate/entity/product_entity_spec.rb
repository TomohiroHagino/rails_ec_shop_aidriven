...
RSpec.describe Domain::ProductAggregate::Entity::ProductEntity do
  let(:product_id) { Domain::ProductAggregate::ValueObject::ProductId.new(1) }
  let(:price) { Domain::ProductAggregate::ValueObject::Price.new(1000) }
  let(:product) do
    described_class.new(
      id: product_id,
      name: 'テスト商品',
  ...
  describe '#change_price' do
    it '価格を変更できる' do
      new_price = Domain::ProductAggregate::ValueObject::Price.new(2000)
